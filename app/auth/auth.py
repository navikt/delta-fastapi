...
class VerifyOauth2Token:
    ...
    async def verify(
        ...
        if self.skip_auth:
            return {"preferred_username": "local@email.no", "name": "Local User"}
